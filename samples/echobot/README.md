...
This Microsoft Teams bot uses the [msbotbuilder-go](https://github.com/manisharma/msbotbuilder-go) library. It shows how to create a simple bot that accepts input from the user and echoes it back.
