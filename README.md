...
[![Build Status](https://travis-ci.org/infracloudio/msbotbuilder-go.svg?branch=develop)](https://travis-ci.org/infracloudio/msbotbuilder-go) [![GoDoc](https://godoc.org/github.com/manisharma/msbotbuilder-go?status.svg)](https://godoc.org/github.com/manisharma/msbotbuilder-go)
...
```sh
$ go get -u github.com/manisharma/msbotbuilder-go/...
```
